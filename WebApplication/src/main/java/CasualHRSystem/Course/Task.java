...
public class Task {
    ...
    private static final String NAME_FIELD_NAME = "activityName";
    private static final String LOCATION_FIELD_NAME = "location";
    private static final String STAFF_FIELD_NAME = "staff";
    private static final String NUM_STAFF_FIELD_NAME = "staff";
    private static final String STUDENTS_FIELD_NAME = "students";
    private static final String DAY_FIELD_NAME = "day";
    private static final String REPEATING_FIELD_NAME = "repeating";
    ...
    @DatabaseField(columnName = TASK_ID_FIELD_NAME)
    private int taskID;
